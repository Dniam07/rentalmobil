...
<body>
            ...
            <div class="nav-bar">
                <nav class="nav_container">
                    ...
                    <ul class="nav_wrapper">
                        <li><a href="" class="dropdown-menu">menu</a></li>
    ...
    <div class="container">
        <div class="form-title">
            <h1 class="h1-form-title">INSERT FORM</h1>
        </div>
            ...
            <form action="" method="post">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <input type="text" name="jenis_mobil" id="jenis_mobil" autocomplete="off"
                            placeholder="Masukkan Jenis Mobil">
                    </li>

                    <li>
                        <label for="nama_mobil">Nama Mobil :</label>
                        <input type="text" name="nama_mobil" id="nama_mobil" autocomplete="off"
                            placeholder="Masukkan Nama Mobil">
                    </li>

                    <li>
                        <label for="harga_harian">Harga Harian :</label>
                        <input type="text" name="harga_harian" id="harga_harian" autocomplete="off"
                            placeholder="Masukkan Harga Harian">
                    </li>


                </ul>
                <button type="submit" name="submit-mobil">kirim</button>
